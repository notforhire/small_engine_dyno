...
void ui_ChartScreen_screen_init(void)
{
    ...
    lv_obj_add_flag(ui_chartScreenHomeButton, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_ADV_HITTEST);
    lv_obj_clear_flag(ui_chartScreenHomeButton, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_set_width(ui_chartScreenHomeButtonLabel, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_chartScreenHomeButtonLabel, LV_SIZE_CONTENT);
    ...
    lv_obj_set_width(ui_chartScreenMapHplabel, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_chartScreenMapHplabel, LV_SIZE_CONTENT);
    ...
    lv_obj_set_width(ui_chartScreenMaxTorqueLabel, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_chartScreenMaxTorqueLabel, LV_SIZE_CONTENT);
    ...
    lv_textarea_set_placeholder_text(ui_chartScreenMaxTorqueField, "Waiting....");
    lv_textarea_set_one_line(ui_chartScreenMaxTorqueField, true);
    lv_obj_clear_flag(ui_chartScreenMaxTorqueField, LV_OBJ_FLAG_SCROLLABLE);
    lv_obj_set_style_text_color(ui_chartScreenMaxTorqueField, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_chartScreenMaxTorqueField, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_chartScreenMaxTorqueField, &ui_font_tomorrow, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_chartScreenMaxTorqueField, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_textarea_set_placeholder_text(ui_chartScreenMaxHpField, "Waiting....");
    ...
    lv_textarea_set_placeholder_text(ui_chartScreenMaxHpRpmField, "Waiting....");
    ...
    lv_textarea_set_placeholder_text(ui_chartScreenMaxTorqueRpmField, "Waiting....");
    ...
    lv_obj_set_width(ui_chartResetButtonLabel, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_chartResetButtonLabel, LV_SIZE_CONTENT);
    ...
    ui_chartScreenChartXLabel = lv_label_create(ui_ChartScreen);
    lv_obj_set_width(ui_chartScreenChartXLabel, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_chartScreenChartXLabel, LV_SIZE_CONTENT);
    lv_obj_set_x(ui_chartScreenChartXLabel, 0);
    lv_obj_set_y(ui_chartScreenChartXLabel, 130);
    lv_obj_set_align(ui_chartScreenChartXLabel, LV_ALIGN_CENTER);
    lv_obj_set_style_text_font(ui_chartScreenChartXLabel, &ui_font_tomorrow18, LV_PART_MAIN | LV_STATE_DEFAULT);
