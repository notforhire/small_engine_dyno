...
void ui_dynoRunScreen_screen_init(void)
{
    ...
    lv_obj_set_width(ui_dynoStartButtonLabel, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_dynoStartButtonLabel, LV_SIZE_CONTENT);
    ...
    lv_obj_set_width(ui_dynoStartHomeButtonLabel, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_dynoStartHomeButtonLabel, LV_SIZE_CONTENT);
    ...
    lv_obj_set_style_outline_pad(ui_dynoRunDirections, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_color(ui_dynoRunDirections, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_opa(ui_dynoRunDirections, 100, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui_dynoRunDirections, 5, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_spread(ui_dynoRunDirections, 10, LV_PART_MAIN | LV_STATE_DEFAULT);
