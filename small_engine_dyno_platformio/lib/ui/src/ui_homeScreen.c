...
void ui_homeScreen_screen_init(void)
{
    ...
    lv_obj_set_width(ui_dynoRunButtonLabel, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_dynoRunButtonLabel, LV_SIZE_CONTENT);
    ...
    lv_obj_set_width(ui_settingsButtonLabel, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_settingsButtonLabel, LV_SIZE_CONTENT);
    ...
    lv_obj_set_width(ui_freestyleButtonLabel, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_freestyleButtonLabel, LV_SIZE_CONTENT);
    ...
    lv_obj_set_width(ui_calibrateButtonLabel, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_calibrateButtonLabel, LV_SIZE_CONTENT);
    ...
    lv_obj_set_style_outline_pad(ui_calibrationWarning, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_outline_pad(ui_safetyAdvisement, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_textarea_set_placeholder_text(ui_dumbFriendWarning, "Placeholder...");
    ...
    lv_obj_set_style_outline_pad(ui_dumbFriendWarning, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
