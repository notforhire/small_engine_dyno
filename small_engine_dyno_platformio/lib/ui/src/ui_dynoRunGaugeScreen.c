...
void ui_dynoRunGaugeScreen_screen_init(void)
{
    ...
    lv_obj_add_flag(ui_dynoRunGaugeBackButton, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLL_ON_FOCUS);
    lv_obj_clear_flag(ui_dynoRunGaugeBackButton, LV_OBJ_FLAG_SCROLL_MOMENTUM | LV_OBJ_FLAG_SCROLL_CHAIN);
    ...
    lv_obj_set_width(ui_dynoRunGaugeBackButtonLabel, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_dynoRunGaugeBackButtonLabel, LV_SIZE_CONTENT);
    ...
    lv_obj_set_width(ui_dynoRunChartButtonLabel, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_dynoRunChartButtonLabel, LV_SIZE_CONTENT);
    ...
    lv_obj_set_width(ui_dynoRunRpmGaugeLabel, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_dynoRunRpmGaugeLabel, LV_SIZE_CONTENT);
    ...
    lv_obj_set_style_arc_opa(ui_dynoRunRpmGaugeArc, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_arc_width(ui_dynoRunRpmGaugeArc, 4, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_dynoRunRpmGaugeArc, lv_color_hex(0xFFFFFF), LV_PART_KNOB | LV_STATE_DEFAULT);
    ...
    lv_obj_set_width(ui_dynoRunTorqueGaugeLabel, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_dynoRunTorqueGaugeLabel, LV_SIZE_CONTENT);
    ...
    lv_obj_set_style_arc_opa(ui_dynoRunTorqueGaugeArc, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_arc_width(ui_dynoRunTorqueGaugeArc, 4, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_dynoRunTorqueGaugeArc, lv_color_hex(0xFFFFFF), LV_PART_KNOB | LV_STATE_DEFAULT);
    ...
    lv_obj_set_width(ui_dynoRunHorsepowerGaugeLabel, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_dynoRunHorsepowerGaugeLabel, LV_SIZE_CONTENT);
    ...
    lv_obj_set_style_shadow_color(ui_dynoRunHorsepowerGaugeArc, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_opa(ui_dynoRunHorsepowerGaugeArc, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_arc_opa(ui_dynoRunHorsepowerGaugeArc, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_arc_width(ui_dynoRunHorsepowerGaugeArc, 4, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_dynoRunHorsepowerGaugeArc, lv_color_hex(0xFFFFFF), LV_PART_KNOB | LV_STATE_DEFAULT);
    ...
    lv_bar_set_start_value(ui_timeoutBar, 0, LV_ANIM_OFF);
    ...
    lv_obj_set_style_bg_grad_color(ui_timeoutBar, lv_color_hex(0xFF0000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui_timeoutBar, LV_GRAD_DIR_HOR, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_outline_color(ui_timeoutBar, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_outline_opa(ui_timeoutBar, 180, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_outline_width(ui_timeoutBar, 3, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_outline_pad(ui_timeoutBar, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_color(ui_timeoutBar, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_opa(ui_timeoutBar, 100, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui_timeoutBar, 5, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_spread(ui_timeoutBar, 10, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_width(ui_runTorqueLabel, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_runTorqueLabel, LV_SIZE_CONTENT);
    ...
    lv_obj_set_width(ui_runHorsepowerLabel, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_runHorsepowerLabel, LV_SIZE_CONTENT);
    ...
    lv_obj_set_width(ui_dynoRunMaxTorqueField, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_dynoRunMaxTorqueField, LV_SIZE_CONTENT);
    ...
    lv_obj_set_width(ui_dynoRunMaxHorsepowerField, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_dynoRunMaxHorsepowerField, LV_SIZE_CONTENT);
    ...
    lv_obj_set_width(ui_atSymbol1, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_atSymbol1, LV_SIZE_CONTENT);
    ...
    lv_obj_set_width(ui_atSymbol2, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_atSymbol2, LV_SIZE_CONTENT);
    ...
    lv_obj_set_width(ui_dynoRunTorqueMaxRpmField, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_dynoRunTorqueMaxRpmField, LV_SIZE_CONTENT);
    ...
    lv_obj_set_width(ui_dynoRunHorsepowerMaxRpmField, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_dynoRunHorsepowerMaxRpmField, LV_SIZE_CONTENT);
    ...
    lv_obj_set_width(ui_rpmLabel1, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_rpmLabel1, LV_SIZE_CONTENT);
    ...
    lv_obj_set_width(ui_rpmLabel2, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_rpmLabel2, LV_SIZE_CONTENT);
    ...
    lv_obj_set_width(ui_runTimeCounter, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_runTimeCounter, LV_SIZE_CONTENT);
    ...
    lv_obj_set_style_text_opa(ui_runTimeCounter, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_width(ui_throttleNotice, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_throttleNotice, LV_SIZE_CONTENT);
    ...
    lv_obj_set_style_text_opa(ui_throttleNotice, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_width(ui_brakeNowNotice, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_brakeNowNotice, LV_SIZE_CONTENT);
    ...
    lv_obj_set_style_text_opa(ui_brakeNowNotice, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
